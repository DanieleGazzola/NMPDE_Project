...
public:
  ...
  class DiffusionCoefficientInside : public Function<dim>
  {
  public:
    // Constructor.
    DiffusionCoefficientInside()
    {}
  ...
  void generateSphere(const unsigned int n, const double r);

  bool sphereIsOverlapped(const Point<dim> &p);

  bool pointIsInASphere(const Point<dim> &p);
...
protected:
  ...
  DiffusionCoefficientInside diffusion_coefficient_inside;
